...
Distinguishing Suicidal Ideation from Depression
A Two-Stage NLP Pipeline with Unsupervised Label Correction
...
Unsupervised Label Correction: Using clustering and confidence thresholds to clean noisy ground-truth labels.

Supervised Classification: Training Deep Neural Networks on the refined data to achieve superior accuracy.

Pipeline Architecture
The system follows a sequential workflow:

Data Collection: Web-scraping Reddit (r/depression, r/SuicideWatch).

Feature Extraction: Generating embeddings using BERT and Google Universal Sentence Encoder (GUSE).

Unsupervised Correction (Phase 1): Dimensionality reduction and clustering to re-label data.

Supervised Classification (Phase 2): Training CNN, Bi-LSTM, and Dense Networks on corrected labels.
...
Threshold (τ): 0.90 (High confidence required to flip a label).
...
└── README.md
References
T. Mikolov et al., "Distributed representations of words and phrases...", NIPS, 2013.
...
E. Elhamifar and R. Vidal, "Sparse subspace clustering...", IEEE Trans. Pattern Anal. Mach. Intell., 2013.
